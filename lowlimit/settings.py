...
WSGI_APPLICATION = 'lowlimit.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('DB_NAME', 'lowlimit'),
        'USER': os.environ.get('DB_USER', 'lluser'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'llpassword'),
